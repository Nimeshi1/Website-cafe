...
if($total != 0){
    ...
    while($result= mysqli_fetch_assoc($data))
    {
        echo "<tr>
             ...
             <td><a href='staff_update.php?id=$result[id]'><input type='submit'value='Update' class='update'></a>

             <a href='staff_delete.php?id=$result[id]'><input type='submit'value='Delete' class='delete' onclick = 'return checkdelete()'></a></td>
             </tr>";
