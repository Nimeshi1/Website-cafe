...
<body>
  ...
  <a href="admin_dash.html"class="btn btn-danger mb-3">Go Back</a>
    ...
    <tr>
     ...
     <td><?php echo $row['total_price'] ?></td>
      ...
      <td> 
        ...
        class="link-dark"><i class="fa-solid fa-trash fs-5 me-3"></i></a> <br><br>

        <a href='order_confirm.php?id=$result[id]'><input type='submit'value='Confirm' class="btn btn-danger mb-3" onclick = 'return checkconfirm()' ></a>
